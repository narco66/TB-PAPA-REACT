...
class UpdateSousProduitRequest extends FormRequest
{
    public function authorize(): bool
    {
        $sp = $this->route('sousProduit') ?? $this->route('sous_produit');

        return $sp instanceof SousProduit
            && ($this->user()?->can('update', $sp) ?? false);
    }
